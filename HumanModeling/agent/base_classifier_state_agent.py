...
class BaseClassifierStateAgent(StateBasedAgent):
    ...
    def loadModel(self, filepath):
        ...
        for reward, h, m, d, l, a, ln in mat:
            state = super()._convertObservationToState(h, m, d, l, a, ln)
    ...
    def getActionByState(self, stateTime, stateDay, stateLocation, stateActivity,
        ...
        self.currentX = self.encode(
                stateTime, stateDay, stateLocation, stateActivity, stateLocation)
