...
/*
 * The `ArrayUtils` class is copied from apache/commons-lang GitHub repository. Here is the link:
 * https://github.com/apache/commons-lang
 *
 * I removed some functions which are self dependent to other classes in the repo, and made some
 * corrections. The following is the license of the of the previous code.
 */
